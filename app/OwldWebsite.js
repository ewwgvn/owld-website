    ...
    <div style={{ background: "#080808", color: "#DCD7CD", fontFamily: "'Times New Roman', Times, serif", overflowX: "hidden" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 18 }}>
          {[
            ...
            <FadeIn key={i} delay={0.12*i}><div style={{ padding: "44px 24px", border: "1px solid rgba(220,215,205,0.04)", transition: "all 0.5s", cursor: "default" }} {...hoverCard}>
              ...
              <p style={{ fontSize: 13, lineHeight: 2, color: "rgba(220,215,205,0.35)", fontWeight: 300 }}>{p.d}</p>
            </div></FadeIn>
          ))}
        </div>
      </section>
      ...
      <section id="portfolio" style={{ borderTop: "1px solid rgba(220,215,205,0.03)" }}>
        <div style={{ padding: "140px 40px 60px", maxWidth: 1100, margin: "0 auto" }}>
          <FadeIn><div style={{ fontSize: 9, letterSpacing: 7, color: "rgba(220,215,205,0.28)", textTransform: "uppercase", marginBottom: 16 }}>Бүтээлүүд</div></FadeIn>
        </div>
      ...
      <section id="shop" style={{ padding: "150px 40px", maxWidth: 1100, margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          ...
          <p style={{ fontSize: 14, color: "rgba(220,215,205,0.28)", fontWeight: 300, maxWidth: 480, margin: "0 auto 50px" }}>Haute couture, бэлэн хувцас, мөн Монгол бичгийн мөнгөн гоёл чимэглэл удахгүй нээлтээ хийнэ.</p>
        </FadeIn>
      ...
      <section id="contact" style={{ padding: "100px 40px 80px", maxWidth: 1100, margin: "0 auto", borderTop: "1px solid rgba(220,215,205,0.03)" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60 }}>
          <FadeIn direction="right"><div>
            <div style={{ fontSize: 9, letterSpacing: 7, color: "rgba(220,215,205,0.28)", textTransform: "uppercase", marginBottom: 28 }}>Холбоо барих</div>
            <h2 style={{ fontSize: 28, fontWeight: 300, letterSpacing: 4, marginBottom: 24 }}>Бидэнтэй холбогдох</h2>
            <div style={{ fontSize: 14, color: "rgba(220,215,205,0.35)", lineHeight: 2.4 }}>galtbilguun0@gmail.com<br/>+82 010-8213-3725<br/><span style={{ marginTop: 8, display: "inline-block" }}>Instagram — @eww.gvn</span></div>
          </div></FadeIn>
          <FadeIn direction="left" delay={0.15}><div>
            <div style={{ fontSize: 9, letterSpacing: 7, color: "rgba(220,215,205,0.28)", textTransform: "uppercase", marginBottom: 28 }}>Байршил</div>
            <div style={{ fontSize: 14, color: "rgba(220,215,205,0.35)", lineHeight: 2.2 }}>Сөүл, Солонгос<br/>Улаанбаатар, Монгол</div>
